                ...
                <div className="container-xxl">
                    <div className="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        <div className="d-flex mx-2 mx-lg-3">
                            <Link className="nav-link text-primary collapsed" href={process.env.PUBLIC_URL +"/wallet-page"} title="Wallet">
                            ...
                            <Dropdown.Menu className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div className="card border-0 w280">
                                    ...
                                    <div className="list-group m-2 ">
                                        <Link href={process.env.PUBLIC_URL +"/profile-page"} className="list-group-item list-group-item-action border-0">
                                        ...
                                        <Link href={process.env.PUBLIC_URL +"/security-page"} className="list-group-item list-group-item-action border-0 ">
                                        ...
                                        <Link href={process.env.PUBLIC_URL +"/identification"} className="list-group-item list-group-item-action border-0 ">
                                        ...
                                        <Link href={process.env.PUBLIC_URL +"/refer-page"} className="list-group-item list-group-item-action border-0 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 32 32" className="me-3">
                                            ...
                                            Referral</Link>
                                        <Link href={process.env.PUBLIC_URL +"/reward-page"} className="list-group-item list-group-item-action border-0 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38" className="me-3">
                                        ...
                                        <Link href={process.env.PUBLIC_URL +"/sign-in"} className="list-group-item list-group-item-action border-0 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" className="me-3">
